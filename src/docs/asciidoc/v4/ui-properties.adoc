...
|springdoc.swagger-ui.syntaxHighlight.theme | `agate` | `String`.  `String=["agate"*, "arta", "monokai", "nord", "obsidian", "tomorrow-night"]`. link:https://highlightjs.org/demo[Highlight.js, window="_blank"] syntax coloring theme to use. (Only these 6 styles are available.)
